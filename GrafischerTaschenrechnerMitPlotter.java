 ...
 */
public class GrafischerTaschenrechnerMitPlotter extends GrafischerTaschenrechner {
    private JTabbedPane tabbedPane;
    private PlotterPanel plotterPanel;

    public GrafischerTaschenrechnerMitPlotter() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            GrafischerTaschenrechnerMitPlotter rechner = new GrafischerTaschenrechnerMitPlotter();
