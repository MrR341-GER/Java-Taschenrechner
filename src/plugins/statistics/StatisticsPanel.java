...
public class StatisticsPanel extends JPanel {
    ...
    private void exportData() {
        ...
        try {
            ...
            sb.append("Standardabweichung: ").append(decimalFormat.format(statisticCalculator.standardDeviation()))
                    .append("\n");
        } catch (IllegalStateException e) {
    ...
    private void calculateStatistics() {
        ...
        if (count > 1) {
            try {
                ...
                result.append("Stichprobenvarianz: ").append(decimalFormat.format(statisticCalculator.variance()))
                        .append("\n");
                result.append("Stichproben-Standardabweichung: ")
                        .append(decimalFormat.format(statisticCalculator.standardDeviation())).append("\n");
                result.append("Populationsvarianz: ")
                        .append(decimalFormat.format(statisticCalculator.populationVariance())).append("\n");
                result.append("Populations-Standardabweichung: ")
                        .append(decimalFormat.format(statisticCalculator.populationStandardDeviation())).append("\n\n");
            } catch (IllegalStateException e) {
        ...
        try {
            ...
            result.append("Geometrisches Mittel: ").append(decimalFormat.format(statisticCalculator.geometricMean()))
                    .append("\n");
            result.append("Harmonisches Mittel: ").append(decimalFormat.format(statisticCalculator.harmonicMean()))
                    .append("\n\n");
        } catch (IllegalStateException e) {
        ...
        if (count >= 4) {
            try {
                ...
                result.append("Interquartilsabstand (IQR): ")
                        .append(decimalFormat.format(statisticCalculator.interquartileRange())).append("\n");
            } catch (IllegalStateException e) {
