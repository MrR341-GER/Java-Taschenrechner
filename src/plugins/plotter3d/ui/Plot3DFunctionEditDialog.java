...
/**
 * Dialog zum Bearbeiten einer 3D-Funktion und ihrer Farbe
 * Ähnlich wie FunctionEditDialog aus dem 2D-Plotter
 */
public class Plot3DFunctionEditDialog extends JDialog {
    ...
    /**
     * Erstellt einen neuen Dialog zum Bearbeiten einer 3D-Funktion
     * 
     ...
     */
    public Plot3DFunctionEditDialog(Frame parent, String title, String function, Color initialColor) {
    ...
    private void layoutComponents() {
        ...
        functionPanel.add(new JLabel("f(x,y) = "), BorderLayout.WEST);
    ...
    public static FunctionEditResult showDialog(Frame parent, String function, Color initialColor) {
        Plot3DFunctionEditDialog dialog = new Plot3DFunctionEditDialog(
                parent,
                "3D-Funktion bearbeiten",
                function,
                initialColor);
