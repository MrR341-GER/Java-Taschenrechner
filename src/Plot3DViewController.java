 ...
 * Kontrolliert Rotation, Zoomfaktor, Grenzen und verschiedene Ansichtseinstellungen
 */
public class Plot3DViewController {
    ...
    public void resetView() {
        ...
        if (xMinField != null) xMinField.setText(String.valueOf(DEFAULT_MIN));
        if (xMaxField != null) xMaxField.setText(String.valueOf(DEFAULT_MAX));
        if (yMinField != null) yMinField.setText(String.valueOf(DEFAULT_MIN));
        if (yMaxField != null) yMaxField.setText(String.valueOf(DEFAULT_MAX));
